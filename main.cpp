...
int main() {
    ...
    try
    {
        Pessoa *p1 = new Pessoa("Daniel Quirino", "Rua João Fernandes", "11/11/1997", true, true , "13642091601");
        ...
        Pessoa *p4 = new Pessoa("Lucas Mello ", "Rua Boaventura", "16/04/1993", true, true , "09038077009");
        ...
        /*casos de erros
            ...
            Pessoa *p5 = new Pessoa("Daniel Quirino", "Rua João Fernandes", "30/02/1997", true, true , "13642091601"); //erro data de nascimento
            Pessoa *p6 = new Pessoa("Filipe Lauar", "Avenida Miguel Perrela", "20/02/1996", true, false , "13494658678"); //erro cpf
            Pessoa *p7 = new Pessoa("Pedro Vieira", "Rua Fernando de Albuquerque", "08/09/1994", false, false , "6888489700010"); //erro cnpj
